...
public class Main {
    ...
    public static void main(String[] args) throws StadiumCapacityException {


        try { // Create a stadium
            ...
            // Play the match
            match.playMatch();
        } catch (StadiumCapacityException | TeamNotFoundException | CoachNotFoundException |
                 RefereeNotFoundException e) {
